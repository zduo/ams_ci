...
class Flexi_auth_model extends Flexi_auth_lite_model
{
	...
	{	
		...
		$sql_select = array(
            ...
            $this->auth->tbl_col_user_account['username'],
			$this->auth->tbl_col_user_account['password'], 
	...
	private function set_login_sessions($user, $logged_in_via_password = FALSE)
	{
		...
		$this->auth->session_data[$this->auth->session_name['user_name']] = $user->{$this->auth->database_config['user_acc']['columns']['username']};
